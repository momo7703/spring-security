...
public class CustomLoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        if (this.postOnly && !request.getMethod().equals("POST")) {
            ...
            CustomLoginAuthenticationToken authRequest = new CustomLoginAuthenticationToken(username, password);
    ...
    protected void setDetails(HttpServletRequest request, CustomLoginAuthenticationToken authRequest) {
